...
if (validateFirebaseConfig()) {
  ...
  // Habilitar persistencia de caché local para reducir lecturas de Firebase
  ...
  console.log(`[FIREBASE] Database initialized with PERSISTENCE on ${typeof window === 'undefined' ? 'SERVER' : 'CLIENT'}. Project: ${firebaseConfig.projectId}`)
} else {
